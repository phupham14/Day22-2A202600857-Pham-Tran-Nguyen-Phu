...
PROMPT_V1_NAME = "phu-rag-v1"
PROMPT_V2_NAME = "phu-rag-v2"
...
SYSTEM_V1 = (
    ...
    "Giữ câu trả lời ngắn gọn, súc tích trong 2-4 câu. "
    "Nếu context không chứa thông tin liên quan, hãy nói rõ điều đó.\n\nContext:\n{context}"
)
...
SYSTEM_V2 = (
    "Bạn là chuyên gia phân tích thông tin. Hãy đọc kỹ context được cung cấp, "
    "xác định các facts quan trọng liên quan đến câu hỏi, sau đó viết câu trả lời "
    "rõ ràng, có tổ chức và chính xác trong 3-5 câu. "
    "Ưu tiên độ chính xác và tính đầy đủ. "
